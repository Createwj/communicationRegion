    ...
    ptrContent.on('refresh', function (e) {
        ...
        setTimeout(function () {
            ...
            var linkHTML = '<li class="item-content">' +
                                ...
                                '</div>' +
                            '</li>';
            ptrContent.find('ul').prepend(linkHTML);//追加到ul前面
